...
title-short: Additional Work
preview-img: qcc-giphy.gif
preview-img-alt: lorem
preview-copy: Gallery of work I've done!
preview-case-name-link: additional-work

banner-vid: banner-vid-test.mp4
h1: Additional Work
h2: A gallery view of additional work.
category-icons:
  - cat-icon: motion.svg
    cat-icon-alt: Motion icon
    cat-icon-label: MOTION
intro-p: Some work is worth showing, but not as a full case study. Enjoy a look through additional samples of my work across a variety of clients!
intro-list-1-h: Role
intro-list-1: list all the bits that I've included
intro-list-2-h: lorem ipsum
intro-list-2: lorem ipsum
intro-list-3-h: lorem ipsum
intro-list-3: lorem ipsum
